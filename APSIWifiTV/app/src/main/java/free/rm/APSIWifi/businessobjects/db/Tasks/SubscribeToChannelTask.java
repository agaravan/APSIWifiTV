...
import free.rm.APSIWifi.gui.fragments.SubscriptionsFeedFragment;
import free.rm.APSIWifi.app.APSIWifiApp;import free.rm.APSIWifi.businessobjects.AsyncTaskParallel;import free.rm.APSIWifi.businessobjects.YouTube.POJOs.YouTubeChannel;import free.rm.APSIWifi.gui.businessobjects.adapters.SubsAdapter;import free.rm.APSIWifi.gui.businessobjects.views.SubscribeButton;import free.rm.APSIWifi.gui.fragments.SubscriptionsFeedFragment;import free.rm.APSIWifi.R;
import free.rm.APSIWifi.app.APSIWifiApp;
import free.rm.APSIWifi.businessobjects.AsyncTaskParallel;
import free.rm.APSIWifi.businessobjects.YouTube.POJOs.YouTubeChannel;
...
public class SubscribeToChannelTask extends AsyncTaskParallel<Void, Void, Boolean> {
	...
	public SubscribeToChannelTask(YouTubeChannel channel) {
		...
		this.context = APSIWifiApp.getContext();
		this.channel = channel;
	...
	protected void onPostExecute(Boolean success) {
		if (success) {
			...
			String err = String.format(APSIWifiApp.getStr(R.string.error_unable_to_subscribe), channel.getId());
