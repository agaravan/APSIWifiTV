...
import free.rm.APSIWifi.app.APSIWifiApp;import free.rm.APSIWifi.gui.businessobjects.MultiSelectListPreferenceItem;import free.rm.APSIWifi.app.APSIWifiApp;
import free.rm.APSIWifi.gui.businessobjects.MultiSelectListPreferenceItem;
import free.rm.APSIWifi.app.APSIWifiApp;
import free.rm.APSIWifi.gui.businessobjects.MultiSelectListPreferenceItem;
...
public class ChannelFilteringDb extends SQLiteOpenHelperEx {
	...
	public static synchronized ChannelFilteringDb getChannelFilteringDb() {
		if (channelFilteringDb == null) {
			channelFilteringDb = new ChannelFilteringDb(APSIWifiApp.getContext());
		}
