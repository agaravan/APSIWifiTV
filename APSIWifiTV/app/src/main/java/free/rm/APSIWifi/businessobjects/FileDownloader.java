...
import free.rm.APSIWifi.gui.activities.PermissionsActivity;
import free.rm.APSIWifi.app.APSIWifiApp;import free.rm.APSIWifi.gui.activities.PermissionsActivity;import free.rm.APSIWifi.gui.activities.PermissionsActivity;
import free.rm.APSIWifi.app.APSIWifiApp;
import free.rm.APSIWifi.gui.activities.PermissionsActivity;
...
public abstract class FileDownloader implements Serializable, PermissionsActivity.PermissionsTask {
	...
	public void displayPermissionsActivity(Context context) {
		Intent i = new Intent(APSIWifiApp.getContext(), PermissionsActivity.class);
	...
	public void download() {
		...
		APSIWifiApp.getContext().registerReceiver(onComplete, new IntentFilter(DownloadManager.ACTION_DOWNLOAD_COMPLETE));
	...
	private void fileDownloadStatus() {
		...
		APSIWifiApp.getContext().unregisterReceiver(onComplete);
	...
	private DownloadManager getDownloadManager() {
		return (DownloadManager) APSIWifiApp.getContext().getSystemService(Context.DOWNLOAD_SERVICE);
	}
