...
import free.rm.APSIWifi.app.APSIWifiApp;import free.rm.APSIWifi.businessobjects.Logger;import free.rm.APSIWifi.BuildConfig;
import free.rm.APSIWifi.app.APSIWifiApp;
import free.rm.APSIWifi.businessobjects.Logger;
import free.rm.APSIWifi.app.APSIWifiApp;
import free.rm.APSIWifi.businessobjects.Logger;
	...
	public static YouTube create() {
		...
		return new YouTube.Builder(httpTransport, jsonFactory, new HttpRequestInitializer() {
			private String getSha1() {
				String sha1 = null;
				try {
					Signature[] signatures = APSIWifiApp.getContext().getPackageManager().getPackageInfo(BuildConfig.APPLICATION_ID, PackageManager.GET_SIGNATURES).signatures;
