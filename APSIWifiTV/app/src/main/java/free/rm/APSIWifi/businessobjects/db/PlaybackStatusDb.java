...
import free.rm.APSIWifi.app.APSIWifiApp;import free.rm.APSIWifi.businessobjects.YouTube.POJOs.YouTubeVideo;import free.rm.APSIWifi.app.APSIWifiApp;
import free.rm.APSIWifi.businessobjects.YouTube.POJOs.YouTubeVideo;
import free.rm.APSIWifi.app.APSIWifiApp;
import free.rm.APSIWifi.businessobjects.YouTube.POJOs.YouTubeVideo;
...
public class PlaybackStatusDb extends SQLiteOpenHelperEx {
	...
	public static synchronized PlaybackStatusDb getVideoDownloadsDb() {
		if (playbackStatusDb == null) {
			playbackStatusDb = new PlaybackStatusDb(APSIWifiApp.getContext());
		}
