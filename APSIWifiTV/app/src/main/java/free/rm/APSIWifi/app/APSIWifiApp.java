...
import free.rm.APSIWifi.businessobjects.FeedUpdaterReceiver;
import free.rm.APSIWifi.businessobjects.FeedUpdaterReceiver;import free.rm.APSIWifi.R;
import free.rm.APSIWifi.businessobjects.FeedUpdaterReceiver;
import free.rm.APSIWifi.businessobjects.FeedUpdaterReceiver;

/**
 * APSI Wifi TV application.
 */
public class APSIWifiApp extends MultiDexApplication {

	/** APSI Wifi TV Application databaseInstance. */
	private static APSIWifiApp aPSIWifiApp = null;

	public static final String KEY_SUBSCRIPTIONS_LAST_UPDATED = "APSIWifiApp.KEY_SUBSCRIPTIONS_LAST_UPDATED";
	public static final String NEW_VIDEOS_NOTIFICATION_CHANNEL = "free.rm.APSIWifi.NEW_VIDEOS_NOTIFICATION_CHANNEL";
	...
	public static String getStr(int stringResId) {
		return aPSIWifiApp.getString(stringResId);
	}
	...
	public static String[] getStringArray(int stringArrayResId) {
		return aPSIWifiApp.getResources().getStringArray(stringArrayResId);
	}
	...
	public static SharedPreferences getPreferenceManager() {
		return PreferenceManager.getDefaultSharedPreferences(aPSIWifiApp);
	}
	...
	public static float getDimension(int dimensionId) {
		return aPSIWifiApp.getResources().getDimension(dimensionId);
	}
	...
	public static int getColorEx(int colorId) {
		return ResourcesCompat.getColor(aPSIWifiApp.getResources(), colorId, null);
	}
	...
	public static Context getContext() {
		return aPSIWifiApp.getBaseContext();
	}
	...
	public static void setFeedUpdateInterval() {
		int feedUpdaterInterval = Integer.parseInt(APSIWifiApp.getPreferenceManager().getString(APSIWifiApp.getStr(R.string.pref_key_feed_notification), "0"));
