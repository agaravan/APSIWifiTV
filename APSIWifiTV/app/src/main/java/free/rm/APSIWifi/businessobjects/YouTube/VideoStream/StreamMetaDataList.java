...
package free.rm.APSIWifi.businessobjects.YouTube.VideoStream;
...
import free.rm.APSIWifi.app.APSIWifiApp;import free.rm.APSIWifi.R;
import free.rm.APSIWifi.app.APSIWifiApp;
import free.rm.APSIWifi.app.APSIWifiApp;
...
public class StreamMetaDataList extends ArrayList<StreamMetaData> {
	...
	public StreamMetaDataList(int errorMessageId) {
		this.errorMessage = APSIWifiApp.getStr(errorMessageId);
	}
	...
	private VideoResolution getDesiredVideoResolution() {
		String resIdValue = APSIWifiApp.getPreferenceManager()
							.getString(APSIWifiApp.getStr(R.string.pref_key_preferred_res),
