...
import free.rm.APSIWifi.businessobjects.YouTube.Tasks.GetVideoStreamTask;
...
import free.rm.APSIWifi.app.APSIWifiApp;import free.rm.APSIWifi.businessobjects.Logger;import free.rm.APSIWifi.businessobjects.YouTube.Tasks.GetVideoStreamTask;import free.rm.APSIWifi.businessobjects.YouTube.VideoStream.StreamMetaData;import free.rm.APSIWifi.businessobjects.interfaces.GetDesiredStreamListener;import free.rm.APSIWifi.R;
import free.rm.APSIWifi.app.APSIWifiApp;
import free.rm.APSIWifi.businessobjects.FileDownloader;
import free.rm.APSIWifi.businessobjects.Logger;
import free.rm.APSIWifi.businessobjects.YouTube.Tasks.GetVideoStreamTask;
import free.rm.APSIWifi.businessobjects.YouTube.VideoStream.StreamMetaData;
import free.rm.APSIWifi.businessobjects.db.BookmarksDb;
...
public class YouTubeVideo implements Serializable {
	...
	public YouTubeVideo(Video video) {
		...
		if (video.getStatistics() != null) {
			...
			this.viewsCount = String.format(APSIWifiApp.getStr(R.string.views), viewsCountInt);
	...
	private void setIsLiveStream() {
		...
		if (duration.equals("0:00")) {
			isLiveStream = true;
			duration = APSIWifiApp.getStr(R.string.LIVE);
		...
		getDesiredStream(new GetDesiredStreamListener() {
			...
			public void onGetDesiredStream(StreamMetaData desiredStream) {
				...
				new VideoDownloader()
						...
						.setTitle(getTitle())
						.setDescription(APSIWifiApp.getStr(R.string.video) + " ― " + getChannelName())
			...
			public void onGetDesiredStreamError(String errorMessage) {
				...
				Toast.makeText(APSIWifiApp.getContext(),
						String.format(APSIWifiApp.getContext().getString(R.string.video_download_stream_error), getTitle()),
						Toast.LENGTH_LONG).show();
			}
		});
	}
	...
	private class VideoDownloader extends FileDownloader implements Serializable {
		...
		public void onFileDownloadStarted() {
			Toast.makeText(APSIWifiApp.getContext(),
					String.format(APSIWifiApp.getContext().getString(R.string.starting_video_download), getTitle()),
					Toast.LENGTH_LONG).show();
		}
		...
		public void onFileDownloadCompleted(boolean success, Uri localFileUri) {
			...
			Toast.makeText(APSIWifiApp.getContext(),
					String.format(APSIWifiApp.getContext().getString(success ? R.string.video_downloaded : R.string.video_download_stream_error), getTitle()),
					Toast.LENGTH_LONG).show();
		}
