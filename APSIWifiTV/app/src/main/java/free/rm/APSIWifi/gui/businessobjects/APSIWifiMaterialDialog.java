...
/**
 * Material dialog for APSI Wifi in which the theme colors are pre-set for convenience.
 */
public class APSIWifiMaterialDialog extends MaterialDialog.Builder {

	public APSIWifiMaterialDialog(@NonNull Context context) {
		super(context);
