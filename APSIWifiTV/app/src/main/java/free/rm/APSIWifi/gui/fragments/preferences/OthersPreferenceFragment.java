...
import free.rm.APSIWifi.businessobjects.AsyncTaskParallel;import free.rm.APSIWifi.gui.businessobjects.adapters.SubsAdapter;import free.rm.APSIWifi.R;
import free.rm.APSIWifi.app.APSIWifiApp;
import free.rm.APSIWifi.businessobjects.AsyncTaskParallel;
import free.rm.APSIWifi.businessobjects.YouTube.ValidateYouTubeAPIKey;
import free.rm.APSIWifi.gui.businessobjects.adapters.SubsAdapter;
import free.rm.APSIWifi.businessobjects.AsyncTaskParallel;
import free.rm.APSIWifi.gui.businessobjects.adapters.SubsAdapter;
	...
	public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
		if(key != null) {
			if (key.equals(getString(R.string.pref_key_default_tab))) {
				...
				APSIWifiApp.setFeedUpdateInterval(interval);
			}*/
		}
	}
