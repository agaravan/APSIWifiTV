...
import free.rm.APSIWifi.gui.activities.PreferencesActivity;
 ...
 */
public class BlockedVideosDialog extends APSIWifiMaterialDialog {
	...
	public static class BlockedVideosAdapter extends RecyclerView.Adapter<ViewHolder> {
		...
		private final int[] rowColors = new int[] {APSIWifiApp.getColorEx(R.color.dialog_row_0), APSIWifiApp.getColorEx(R.color.dialog_row_1)};
