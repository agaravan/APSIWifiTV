...
package free.rm.APSIWifi.gui.businessobjects.adapters;
...
import free.rm.APSIWifi.businessobjects.YouTube.GetCommentThreads;
...
import free.rm.APSIWifi.businessobjects.YouTube.POJOs.YouTubeComment;
import free.rm.APSIWifi.businessobjects.YouTube.POJOs.YouTubeCommentThread;
...
public class CommentsAdapter extends BaseExpandableListAdapter {
	...
	private class CommentViewHolder {
		...
		protected void updateInfo(final YouTubeComment comment, boolean isTopLevelComment, final int groupPosition) {
			...
			lp.width = (int) APSIWifiApp.getDimension(isTopLevelComment  ?  R.dimen.top_level_comment_thumbnail_width  :  R.dimen.child_comment_thumbnail_width);
