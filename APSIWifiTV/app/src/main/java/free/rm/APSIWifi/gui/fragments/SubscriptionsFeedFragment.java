...
import free.rm.APSIWifi.businessobjects.FeedUpdaterService;
import free.rm.APSIWifi.businessobjects.VideoCategory;
import free.rm.APSIWifi.gui.businessobjects.SubscriptionsBackupsManager;
import free.rm.APSIWifi.gui.businessobjects.adapters.SubsAdapter;
import free.rm.APSIWifi.businessobjects.AsyncTaskParallel;import free.rm.APSIWifi.businessobjects.FeedUpdaterService;import free.rm.APSIWifi.businessobjects.VideoCategory;import free.rm.APSIWifi.gui.businessobjects.SubscriptionsBackupsManager;import free.rm.APSIWifi.gui.businessobjects.adapters.SubsAdapter;import free.rm.APSIWifi.R;
...
import free.rm.APSIWifi.businessobjects.YouTube.Tasks.GetSubscriptionVideosTask;
import free.rm.APSIWifi.businessobjects.YouTube.Tasks.GetSubscriptionVideosTaskListener;
...
public class SubscriptionsFeedFragment extends VideosGridFragment implements GetSubscriptionVideosTaskListener {
	...
	public void onCreate(@Nullable Bundle savedInstanceState) {
		...
		long l = APSIWifiApp.getPreferenceManager().getLong(APSIWifiApp.KEY_SUBSCRIPTIONS_LAST_UPDATED, -1);
	...
	private boolean isFlagSet(String flag) {
		return APSIWifiApp.getPreferenceManager().getBoolean(flag, false);
	}
	...
	public void onChannelVideosFetched(YouTubeChannel channel, List<YouTubeVideo> videosFetched, final boolean videosDeleted) {
		...
		if(progressDialog != null)
			progressDialog.setContent(String.format(APSIWifiApp.getStr(R.string.fetched_videos_from_channels), numVideosFetched, numChannelsFetched, numChannelsSubscribed));
	...
	public String getFragmentName() {
		return APSIWifiApp.getStr(R.string.feed);
	}
