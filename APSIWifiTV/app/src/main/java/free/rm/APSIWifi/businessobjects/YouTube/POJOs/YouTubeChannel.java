...
import free.rm.APSIWifi.app.APSIWifiApp;import free.rm.APSIWifi.businessobjects.Logger;import free.rm.APSIWifi.R;
import free.rm.APSIWifi.app.APSIWifiApp;
import free.rm.APSIWifi.businessobjects.Logger;
...
import free.rm.APSIWifi.businessobjects.db.Tasks.SubscribeToChannelTask;
import free.rm.APSIWifi.app.APSIWifiApp;
import free.rm.APSIWifi.businessobjects.Logger;
...
public class YouTubeChannel implements Serializable {
	...
	private void parse(Channel channel) {
		...
		if (branding != null)
			this.bannerUrl = APSIWifiApp.isTablet() ? branding.getImage().getBannerTabletHdImageUrl() : branding.getImage().getBannerMobileHdImageUrl();

		ChannelStatistics statistics = channel.getStatistics();
		if (statistics != null) {
			this.totalSubscribers = String.format(APSIWifiApp.getStr(R.string.total_subscribers),
