...
package free.rm.APSIWifi.gui.businessobjects.fragments;
...
import free.rm.APSIWifi.businessobjects.Logger;import free.rm.APSIWifi.R;
...
public class ImmersiveModeFragment extends FragmentEx {
	...
	protected boolean userWantsImmersiveMode() {
		return ! APSIWifiApp.getPreferenceManager().getBoolean(getString(R.string.pref_key_disable_immersive_mode), false);
	}
