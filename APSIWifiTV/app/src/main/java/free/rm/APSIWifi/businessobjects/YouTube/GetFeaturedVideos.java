...
import free.rm.APSIWifi.businessobjects.YouTube.POJOs.YouTubeAPI;
import free.rm.APSIWifi.businessobjects.YouTube.POJOs.YouTubeAPIKey;
import free.rm.APSIWifi.businessobjects.YouTube.POJOs.YouTubeVideo;
import free.rm.APSIWifi.app.APSIWifiApp;import free.rm.APSIWifi.businessobjects.Logger;import free.rm.APSIWifi.businessobjects.YouTube.POJOs.YouTubeAPI;import free.rm.APSIWifi.businessobjects.YouTube.POJOs.YouTubeAPIKey;import free.rm.APSIWifi.businessobjects.YouTube.POJOs.YouTubeVideo;import free.rm.APSIWifi.R;
import free.rm.APSIWifi.app.APSIWifiApp;
import free.rm.APSIWifi.businessobjects.Logger;
import free.rm.APSIWifi.businessobjects.YouTube.POJOs.YouTubeAPI;
import free.rm.APSIWifi.businessobjects.YouTube.POJOs.YouTubeAPIKey;
...
public class GetFeaturedVideos extends GetYouTubeVideos {
	...
	private String getPreferredRegion() {
		String region = APSIWifiApp.getPreferenceManager()
				.getString(APSIWifiApp.getStr(R.string.pref_key_preferred_region), "").trim();
