...
import free.rm.APSIWifi.app.APSIWifiApp;import free.rm.APSIWifi.gui.businessobjects.views.SubscribeButton;import free.rm.APSIWifi.R;
import free.rm.APSIWifi.app.APSIWifiApp;
...
public class CheckIfUserSubbedToChannelTask extends AsyncTask<Void, Void, Boolean> {
	...
	protected void onPostExecute(Boolean isUserSubbed) {
		if (isUserSubbed == null) {
			String err = String.format(APSIWifiApp.getStr(R.string.error_check_if_user_has_subbed), channelId);
