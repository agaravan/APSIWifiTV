...
import free.rm.APSIWifi.app.APSIWifiApp;import free.rm.APSIWifi.businessobjects.AsyncTaskParallel;import free.rm.APSIWifi.gui.businessobjects.adapters.SubsAdapter;import free.rm.APSIWifi.app.APSIWifiApp;
import free.rm.APSIWifi.businessobjects.AsyncTaskParallel;
...
public class GetSubscriptionVideosTask extends AsyncTaskParallel<Void, Void, Void> {
	...
	public static void updateFeedsLastUpdateTime(DateTime dateTime) {
		...
		editor.putLong(APSIWifiApp.KEY_SUBSCRIPTIONS_LAST_UPDATED, dateTime != null  ?  dateTime.getValue()  :  -1);
		editor.commit();
	}
