...
package free.rm.APSIWifi.gui.businessobjects.updates;
...
import free.rm.APSIWifi.businessobjects.AsyncTaskParallel;import free.rm.APSIWifi.R;
import free.rm.APSIWifi.businessobjects.AsyncTaskParallel;
import free.rm.APSIWifi.businessobjects.AsyncTaskParallel;

/**
 * A task that will check if any APSI Wifi updates have been published.  If there are, then the
 * user will be notified.
 */
public class UpdatesCheckerTask extends AsyncTaskParallel<Void, Void, UpdatesChecker> {

	/** If set to true, it will display the "APSI Wifi is up to date" message.  */
	 ...
	 * @param displayUpToDateMessage    If set to true, it will display the "APSI Wifi is up to date"
