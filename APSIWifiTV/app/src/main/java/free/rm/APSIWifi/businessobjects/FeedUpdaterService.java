...
public class FeedUpdaterService extends Service implements GetSubscriptionVideosTaskListener {
	...
	public void onAllChannelVideosFetched() {
		if(newVideosFetched.size() > 0) {
			...
			Notification notification = new NotificationCompat.Builder(this, APSIWifiApp.NEW_VIDEOS_NOTIFICATION_CHANNEL)
			...
			notificationManager.notify(APSIWifiApp.NEW_VIDEOS_NOTIFICATION_CHANNEL_ID, notification);
