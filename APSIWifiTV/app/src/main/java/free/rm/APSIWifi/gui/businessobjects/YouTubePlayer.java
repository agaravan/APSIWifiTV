...
import free.rm.APSIWifi.gui.activities.YouTubePlayerActivity;
...
public class YouTubePlayer {
	...
	private static boolean useOfficialYouTubePlayer(Context context) {
		...
		String              str = sharedPref.getString(APSIWifiApp.getStr(R.string.pref_key_choose_player), APSIWifiApp.getStr(R.string.pref_default_player_value));

		return  (str.equals(APSIWifiApp.getStr(R.string.pref_official_player_value)));
	}
