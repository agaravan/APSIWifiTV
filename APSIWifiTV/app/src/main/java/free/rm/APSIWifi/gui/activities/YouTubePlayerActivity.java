...
import free.rm.APSIWifi.gui.businessobjects.BackButtonActivity;
import free.rm.APSIWifi.gui.businessobjects.fragments.FragmentEx;
import free.rm.APSIWifi.gui.businessobjects.BackButtonActivity;import free.rm.APSIWifi.gui.businessobjects.fragments.FragmentEx;import free.rm.APSIWifi.R;
import free.rm.APSIWifi.app.APSIWifiApp;
import free.rm.APSIWifi.businessobjects.interfaces.YouTubePlayerFragmentInterface;
import free.rm.APSIWifi.gui.businessobjects.BackButtonActivity;
import free.rm.APSIWifi.gui.businessobjects.fragments.FragmentEx;
import free.rm.APSIWifi.gui.fragments.YouTubePlayerFragment;
import free.rm.APSIWifi.gui.fragments.YouTubePlayerTutorialFragment;
import free.rm.APSIWifi.gui.fragments.YouTubePlayerV2Fragment;
import free.rm.APSIWifi.gui.businessobjects.BackButtonActivity;
import free.rm.APSIWifi.gui.businessobjects.fragments.FragmentEx;

/**
 * An {@link Activity} that contains an instance of
 * {@link free.rm.APSIWifi.gui.fragments.YouTubePlayerFragment}.
 */
public class YouTubePlayerActivity extends BackButtonActivity {
	...
	/**
	 * @return True if the user wants to use APSI Wifi's default video player;  false if the user wants
	...
	private boolean useDefaultPlayer() {
		...
		final String str = APSIWifiApp.getPreferenceManager().getString(getString(R.string.pref_key_choose_player), defaultPlayerValue);
	...
	private boolean wasTutorialDisplayedBefore() {
		SharedPreferences preferences = APSIWifiApp.getPreferenceManager();
	...
	private void installFragment(FragmentEx fragment) {
		// either use the APSI Wifi's default video player or the legacy one
	...
	protected void onStart() {
		...
		String  str = APSIWifiApp.getPreferenceManager().getString(getString(R.string.pref_key_screen_orientation), getString(R.string.pref_screen_auto_value));
