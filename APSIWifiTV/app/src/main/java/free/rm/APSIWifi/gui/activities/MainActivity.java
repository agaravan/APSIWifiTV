...
package free.rm.APSIWifi.gui.activities;
...
import free.rm.APSIWifi.gui.businessobjects.BlockedVideosDialog;
import free.rm.APSIWifi.gui.businessobjects.MainActivityListener;
import free.rm.APSIWifi.gui.businessobjects.adapters.SearchHistoryCursorAdapter;
import free.rm.APSIWifi.gui.businessobjects.updates.UpdatesCheckerTask;
import free.rm.APSIWifi.gui.businessobjects.BlockedVideosDialog;import free.rm.APSIWifi.gui.businessobjects.MainActivityListener;import free.rm.APSIWifi.gui.businessobjects.adapters.SearchHistoryCursorAdapter;import free.rm.APSIWifi.gui.businessobjects.updates.UpdatesCheckerTask;import free.rm.APSIWifi.R;
...
import free.rm.APSIWifi.businessobjects.YouTube.VideoBlocker;
import free.rm.APSIWifi.businessobjects.db.DownloadedVideosDb;
import free.rm.APSIWifi.businessobjects.db.SearchHistoryDb;
import free.rm.APSIWifi.businessobjects.db.SearchHistoryTable;
import free.rm.APSIWifi.businessobjects.interfaces.SearchHistoryClickListener;
import free.rm.APSIWifi.gui.businessobjects.BlockedVideosDialog;
import free.rm.APSIWifi.gui.businessobjects.MainActivityListener;
import free.rm.APSIWifi.gui.businessobjects.YouTubePlayer;
import free.rm.APSIWifi.gui.businessobjects.adapters.SearchHistoryCursorAdapter;
import free.rm.APSIWifi.gui.businessobjects.updates.UpdatesCheckerTask;
import free.rm.APSIWifi.gui.fragments.ChannelBrowserFragment;
import free.rm.APSIWifi.gui.fragments.MainFragment;
import free.rm.APSIWifi.gui.fragments.PlaylistVideosFragment;
import free.rm.APSIWifi.gui.fragments.SearchVideoGridFragment;
import free.rm.APSIWifi.gui.businessobjects.BlockedVideosDialog;
import free.rm.APSIWifi.gui.businessobjects.MainActivityListener;
import free.rm.APSIWifi.gui.businessobjects.adapters.SearchHistoryCursorAdapter;
import free.rm.APSIWifi.gui.businessobjects.updates.UpdatesCheckerTask;
...
/**
 * Main activity (launcher).  This activity holds {@link free.rm.APSIWifi.gui.fragments.VideosGridFragment}.
 */
public class MainActivity extends AppCompatActivity implements MainActivityListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		APSIWifiApp.setFeedUpdateInterval();
	...
	public boolean onCreateOptionsMenu(final Menu menu) {
		...
		searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
			...
			public boolean onQueryTextChange(final String newText) {
				...
				if (APSIWifiApp.getPreferenceManager().getBoolean(getString(R.string.pref_key_disable_search_history), false)
			...
			public boolean onQueryTextSubmit(String query) {
				if(!APSIWifiApp.getPreferenceManager().getBoolean(APSIWifiApp.getStr(R.string.pref_key_disable_search_history), false)) {
