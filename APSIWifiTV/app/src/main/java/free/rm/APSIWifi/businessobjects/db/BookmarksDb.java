...
public class BookmarksDb extends SQLiteOpenHelperEx implements OrderableDatabase {
	...
	public static synchronized BookmarksDb getBookmarksDb() {
		if (bookmarksDb == null) {
			bookmarksDb = new BookmarksDb(APSIWifiApp.getContext());
		}
